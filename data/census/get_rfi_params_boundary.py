...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=["AL", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY"],  # Default value if not provided
...
def fetch_population_data(state_abbr, entity_type):
    """
...
def calculate_racial_fragmentation(population_data):
    """
    ...
    for entry in population_data:
        ...
        total_population = sum([
            ...
            data.get("B03002_003E", 0),  # Hispanic or Latino
        ])
        ...
        proportions = [
            ...
            data.get("B03002_003E", 0) / total_population,  # Hispanic or Latino
        ]
        ...
        results.append({"entity_name": entity_name, "fragmentation_index": rfi, "state": entry["state"], "entity": entry["entity"], "GEOID": geoid})
...
def create_rfi_map(rfi_results, state_ids, entity_type, save_name, shapefile_path):
    ...
    entities_merged.to_csv(f"{save_name}.csv")
...
def main():
    ...
    for state_abbr in state_abbreviations: 
        ...
        population_data = fetch_population_data(state_abbr, entity_type)
        ...
        rfi_results = calculate_racial_fragmentation(population_data)
        print("RFI Results")
        print(rfi_results)
